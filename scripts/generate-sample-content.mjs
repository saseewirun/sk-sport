...
const products = [
  product('Outdoor Exercise Equipment', 'outdoor-exercise-equipment', '/outdoor-exercise-equipment.png', 'Fitness'),
  product('Gymnastic Equipment', 'gymnastic-equipment', '/gymnastic-equipment.png', 'Gymnastics'),
  product('Integrated Sports Set', 'integrated-sports-set', '/integrated-sports-installation.png', 'Fitness'),
]
...
const portfolioArticles = [
  article('โครงการตัวอย่างที่ 1', 'sample-project-1', '/portfolio-article-1.jpg', 'Installation', NOW),
  article('โครงการตัวอย่างที่ 2', 'sample-project-2', '/portfolio-article-2.png', 'Fitness', '2026-05-20T00:00:00.000Z'),
  article('โครงการตัวอย่างที่ 3', 'sample-project-3', '/portfolio-article-3.png', 'Gymnastics', EARLIER),
]
...
console.log('Done. ⚠️ SAMPLE data only — run scripts/export-from-payload.mjs for real customer data.')
